...
public class BoardMgr {
	...
	public void updateReadcnt(String num){	//글 내용보기하면 조회 수 증가
		...
		try {
			...
			System.out.println("update Readcnt err : " + e);
		}finally {
			try {
				if (rs != null)	rs.close();
				if (pstmt != null) pstmt.close();
	...
	public void updateOnum(int gnum, int onum){	//댓글용 - onum 갱신을 위한 처리
